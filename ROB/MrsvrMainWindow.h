...
#define INFCNV_WARN_LOCK_X             0.18
#define INFCNV_WARN_LOCK_Y             INFCNV_VALUE1_Y
#define INFCNV_WARN_OUTOFRANGE_X       0.18
#define INFCNV_WARN_OUTOFRANGE_Y       INFCNV_VALUE2_Y
#define INFCNV_WARN_NOLIMITER_X        0.31
#define INFCNV_WARN_NOLIMITER_Y        INFCNV_VALUE1_Y
#define INFCNV_WARN_NOCOMMUNICATION_X  0.31
#define INFCNV_WARN_NOCOMMUNICATION_Y  INFCNV_VALUE2_Y
#define INFCNV_WARN_REACHED_X          0.44
#define INFCNV_WARN_REACHED_Y          INFCNV_VALUE1_Y
#define INFCNV_WARN_NOCALIBRATION_X    0.44
#define INFCNV_WARN_NOCALIBRATION_Y    INFCNV_VALUE2_Y
#define INFCNV_WARN_FOOTSWITCHOFF_X     0.57
#define INFCNV_WARN_FOOTSWITCHOFF_Y     INFCNV_VALUE1_Y
...
#define NEEDLECNV_LABEL_X         10

#define NEEDLECNV_DEPTH_LABEL_X   NEEDLECNV_LABEL_X
#define NEEDLECNV_DEPTH_LABEL_Y   20

#define NEEDLECNV_DEPTH_VALUE_X   (NEEDLECNV_LABEL_X+10)
#define NEEDLECNV_DEPTH_VALUE_Y   60

#define NEEDLECNV_DEPTH_UNIT_X    200
#define NEEDLECNV_DEPTH_UNIT_Y    60

#define NEEDLECNV_TARGET_LABEL_X  NEEDLECNV_LABEL_X
#define NEEDLECNV_TARGET_LABEL_Y  100

#define NEEDLECNV_TARGET_X        (NEEDLECNV_LABEL_X+10)
#define NEEDLECNV_TARGET_Y        140

#define NEEDLECNV_TARGET_DIR_W    30
#define NEEDLECNV_TARGET_VAL_W    100

#define NEEDLECNV_CURRENT_LABEL_X  NEEDLECNV_LABEL_X
#define NEEDLECNV_CURRENT_LABEL_Y  180

#define NEEDLECNV_CURRENT_X       (NEEDLECNV_LABEL_X+10)
#define NEEDLECNV_CURRENT_Y       220

#define NEEDLECNV_CURRENT_DIR_W   30
#define NEEDLECNV_CURRENT_VAL_W   100
